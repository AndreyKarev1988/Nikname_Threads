...
public class Main {
    ...
    public static int fourLetters = 0;
    public static int fiveLetters = 0;

    public static void main(String[] args) throws InterruptedException {

        AtomicInteger threeLetterAtom = new AtomicInteger(threeLetters);
        AtomicInteger fourLetterAtom = new AtomicInteger(fourLetters);
        AtomicInteger fiveLetterAtom = new AtomicInteger(fiveLetters);
